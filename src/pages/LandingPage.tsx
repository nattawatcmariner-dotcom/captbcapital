        ...
        hero: {
            ...
            desc: (
                <>
                    ...
                    We are a diversified group committed to excellence in <span className="font-medium">Marine Logistics</span>, <span className="font-medium">EV Transportation</span>, and <span className="font-medium">Modern Real Estate</span>.
                </>
            )
        },
        parcels: {
        ...
        hero: {
            ...
            desc: (
                <>
                    ...
                    เราคือกลุ่มบริษัทชั้นนำที่มุ่งมั่นสู่ความเป็นเลิศในด้าน <span className="font-medium">โลจิสติกส์ทางทะเล</span>, <span className="font-medium">ยานยนต์ไฟฟ้า (EV)</span>, และ <span className="font-medium">อสังหาริมทรัพย์ยุคใหม่</span>.
                </>
            )
        },
        parcels: {
        ...
        <div className="min-h-screen bg-white font-sans text-slate-900 relative">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 pb-24">
                <div className="grid md:grid-cols-3 gap-8">
                    ...
                    <div className="group relative rounded-3xl overflow-hidden bg-white border border-slate-200 shadow-xl transition-all duration-500 hover:scale-[1.02] hover:border-blue-300 group-hover:shadow-blue-500/10 cursor-pointer"
                        ...
                        <div className="p-8">
                            ...
                            <div className="inline-flex items-center gap-2 text-blue-600 font-bold group-hover:text-blue-500 transition-colors">
                    ...
                    {/* PARCEL 2: CAPT CAR */}
                    <div className="group relative rounded-3xl overflow-hidden bg-white border border-slate-200 shadow-xl transition-all duration-500 hover:scale-[1.02] hover:border-emerald-300 group-hover:shadow-emerald-500/10">
                        {/* Image */}
                        <div className="h-[280px] bg-slate-50 overflow-hidden relative">
                        ...
                        <div className="p-8">
                            ...
                            <div className="inline-flex items-center gap-2 text-slate-400 font-medium text-sm bg-slate-100 px-4 py-2 rounded-full">
                                {t.parcels.car.action}
                            </div>
                        </div>
                    </div>

                    {/* PARCEL 3: CAPT HOUSE */}
                    <div className="group relative rounded-3xl overflow-hidden bg-white border border-slate-200 shadow-xl transition-all duration-500 hover:scale-[1.02] hover:border-amber-300 group-hover:shadow-amber-500/10">
                        {/* Image */}
                        <div className="h-[280px] bg-slate-50 overflow-hidden relative">
