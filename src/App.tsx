...
const CaptCarPage = lazy(() => import('./pages/CaptCarPage').then(module => ({ default: module.CaptCarPage })));
const CaptCarFleetPage = lazy(() => import('./pages/CaptCarFleetPage').then(module => ({ default: module.CaptCarFleetPage }))); // NEW
const CaptCarBookingPage = lazy(() => import('./pages/CaptCarBookingPage').then(module => ({ default: module.CaptCarBookingPage }))); // NEW
const CaptHousePage = lazy(() => import('./pages/CaptHousePage').then(module => ({ default: module.CaptHousePage })));
      ...
      <BrowserRouter>
        <Suspense fallback={<LoadingScreen />}>
          <Routes>
            ...
            <Route path="/car" element={<CaptCarPage />} />
            <Route path="/car/fleet" element={<CaptCarFleetPage />} />
            <Route path="/car/book/:id" element={<CaptCarBookingPage />} />
            <Route path="/house" element={<CaptHousePage />} />
